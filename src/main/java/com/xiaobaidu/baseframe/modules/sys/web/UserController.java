...
import com.xiaobaidu.baseframe.common.beanvalidator.BeanValidators;
...
import com.xiaobaidu.baseframe.common.utils.excel.ExportExcel;
import com.xiaobaidu.baseframe.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) throws UnsupportedEncodingException {
		if(null != user.getOffice()&& null != user.getOffice().getName()){
