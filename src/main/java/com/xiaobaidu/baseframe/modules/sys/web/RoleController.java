...
import com.xiaobaidu.baseframe.common.utils.Collections3;
...
import com.xiaobaidu.baseframe.modules.sys.service.OfficeService;
import com.xiaobaidu.baseframe.modules.sys.service.SystemService;
...
public class RoleController extends BaseController {
	...
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) {
		...
		if (!"true".equals(checkEnname(role.getOldEnname(), role.getEnname(),role.getId()))){
	...
	public String checkName(String oldName, String name,String id) {
		if (name!=null && name.equals(oldName)) {
			return "true";
		} else if (name!=null && systemService.getRoleByName(name,id) == null) {
			return "true";
		}
		return "false";
	}
	...
	public String checkEnname(String oldEnname, String enname,String id) {
		if (enname!=null && enname.equals(oldEnname)) {
			return "true";
		} else if (enname!=null && systemService.getRoleByEnname(enname,id) == null) {
			return "true";
		}
		return "false";
	}
